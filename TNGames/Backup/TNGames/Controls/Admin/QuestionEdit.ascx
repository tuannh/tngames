<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QuestionEdit.ascx.cs"
    Inherits="TNGames.Controls.Admin.QuestionEdit" %>
<h1 class="header">
    Thêm/sửa
</h1>
                        ...
                        <tr class="Table">
                            <td valign="middle">
                                ...
                                <asp:TextBox ID="txtQuestionName" TextMode="MultiLine" Height="90px" Width="350px"
                                    MaxLength="150" runat="server" Text='<%# Eval("QuestionName")%>' />
                                ...
                                <asp:Repeater ID="rptAnswer" runat="server" ClientIDMode="Predictable">
                                    ...
                                    <ItemTemplate>
                                        <li id="trAnswer" runat="server">
                                            ...
                                            <asp:RequiredFieldValidator ValidationGroup="QG" ForeColor="Red" ID="rfv" runat="server"
                                                ErrorMessage="*" ControlToValidate="txtAnswer" />
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ValidationGroup="new" ForeColor="Red" ID="RequiredFieldValidator2"
                        runat="server" ErrorMessage="Câu hỏi không thể rỗng" ControlToValidate="txtQuestion"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td class="contentbold">
                    ...
                    <asp:Repeater ID="rptAnswers" runat="server" ClientIDMode="Predictable" OnItemDataBound="rptAnswers_ItemDataBound">
                        <ItemTemplate>
                            ...
                            <asp:TextBox ID="txtAnswer" ValidationGroup="new" runat="server" MaxLength="150"
                                Width="300px" CssClass='<%# "atxt" + Container.ItemIndex %>' />
                            <asp:RequiredFieldValidator ValidationGroup="new" ForeColor="Red" ID="rfv" runat="server"
                                ErrorMessage="Bạn chưa nhập đáp án" ControlToValidate="txtAnswer" />
...
//<![CDATA[
    ...
    $(document).ready(function () {
        ...
        // disable answer 3, 4, 5
        $('.radio :radio').each(function (i, e) {
            if (i > 1)
                e.disabled = true;
        })

        // enable answer radio if answer text is not empty
        $('.atxt2, .atxt3, .atxt4').blur(function () {
            if (this.value.replace(/\s/g, '') == '')
                $(this).prev().find(':radio').attr('disabled', true);
            else
                $(this).prev().find(':radio').attr('disabled', false);
        })
    })
