<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Skin-BettingWinBoards.ascx.cs"
    Inherits="TNGames.Controls.FrontEnd.Skin_BettingWinBoards" %>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td height="40">
            <img src="/images/web/bangxephanggame.png" width="184" height="32" />
        </td>
    </tr>
    <tr>
        <td>
            ...
            <pager:Pager ID="pager" runat="server" CompactModePageCount="5" NormalModePageCount="5"
